...
import ProductList from "../../components/product/products list/ProductList";
...
function Home() {
  ...
  return (
    <div className="bg-gray-200 dark:bg-slate-800 pt-3 relative z-0 transition-all duration-300 hover:transition-all hover:duration-300 after:transition-all after:duration-500 after:hover:transition-all after:hover:duration-500 overflow-hidden after:-translate-y-full after:hover:translate-y-0 [&_p]:delay-200 [&_p]:transition-all">

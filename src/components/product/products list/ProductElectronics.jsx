  ...
  return (
    <section className="">
      {isLoading ? (
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 bg-transparent bg-gray-200 dark:bg-slate-800 pt-3 relative z-0 transition-all duration-300 hover:transition-all hover:duration-300 after:transition-all after:duration-500 after:hover:transition-all after:hover:duration-500 overflow-hidden after:-translate-y-full after:hover:translate-y-0 [&_p]:delay-200 [&_p]:transition-all">
